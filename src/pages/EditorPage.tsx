...
import { categories, sponsors, filterOptions, legislativeStages } from "@/data/mockData";
...
export default function EditorPage() {
  ...
  const addStage = () => {
    ...
    setStages([...stages, { id: newId, name: "", date: "", status: "pending" }]);
  };
    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl lg:text-3xl font-bold mb-8">Tworzenie nowego aktu prawnego</h1>

          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Basic info */}
            <div className="gov-card">
              <h2 className="text-lg font-semibold mb-6">Informacje podstawowe</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Select value={formData.sponsor} onValueChange={(v) => handleChange("sponsor", v)}>
                    <SelectTrigger className="mt-2 h-12">
            ...
            {/* Consultations */}
            <div className="gov-card">
              <h2 className="text-lg font-semibold mb-6">Konsultacje publiczne</h2>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <Label htmlFor="hasConsultation" className="text-base cursor-pointer">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleChange("consultationStart", e.target.value)}
                      className="mt-2 h-12"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleChange("consultationEnd", e.target.value)}
                      className="mt-2 h-12"
                    />
                  </div>
                </div>
            ...
            <div className="gov-card">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold">Etapy procesu legislacyjnego</h2>
              ...
              <div className="space-y-4">
                {stages.map((stage, index) => (
                  <div key={stage.id} className="flex items-start gap-4 p-4 border border-border rounded-lg">
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Select value={stage.name} onValueChange={(v) => updateStage(stage.id, "name", v)}>
